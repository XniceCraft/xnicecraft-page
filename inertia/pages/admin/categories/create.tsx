      ...
      <AdminLayout>
        <AdminContainer>
          <header className="border-b border-rule pb-6">
            <Button asChild variant="ghost" size="sm" className="mb-5 w-fit">
              <Link route="admin.categories.index">
                <ArrowLeftIcon className="size-4" aria-hidden="true" />
                Back to categories
              </Link>
            </Button>
            <p className="font-mono text-xs tracking-[0.18em] text-ink-3 uppercase">New category</p>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
              Create category
            </h1>
            <p className="mt-3 text-sm leading-6 text-ink-2 sm:text-base">
              Add a focused content group with a readable slug for URLs.
            </p>
          </header>
